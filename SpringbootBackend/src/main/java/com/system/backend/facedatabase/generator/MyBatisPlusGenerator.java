package com.system.backend.facedatabase.generator;
...
//    该函数用于生成代码
//    @Test：该注解为junit单元测试中的注解，作用可以单独运行
    @Test
    public void codeGenerator() {
        ...
        gc.setAuthor("");//Mapper,Service类注解中显示创建人信息
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/facedatabase?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("com.system.backend.facedatabase");  //父级公用包名，就是自动生成的文件放在项目路径下的那个包中
